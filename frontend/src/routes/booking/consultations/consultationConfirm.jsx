    ...
    const verifyToken = async () => {
      try {
        ...
        if (!token) {
          ...
          navigate('/login', { state: { from: '/consultations/confirm' } });
          return;
        }
            ...
            <Card className="shadow text-center" style={{ backgroundColor: 'white', color: '#212529' }}>
              <Card.Body>
                ...
                <Card.Text className="mt-3">
                  Your consultation request has been successfully submitted. You will receive a confirmation email shortly.
                </Card.Text>
                <Card.Text className="mt-3">
                ...
                <Card.Text className="mt-3">
                  We will contact you to confirm the consultation date and time.
                </Card.Text>
                <div className="mt-4">
                  <Button
                    variant="dark"
